...
const page = () => {
    return (
        <Section className="relative pt-20 pb-20">
            ...
            <h3 className="h3 mt-12">Our Vision</h3>
            ...
            <h3 className="h3 mt-12">Objectives</h3>
            ...
            <h3 className="h3 mt-12">Research Framework</h3>
            ...
            <h3 className="h3 mt-12">Project Impact</h3>
            ...
            <h3 className="h3 mt-12">Join Us in Making a Difference</h3>
