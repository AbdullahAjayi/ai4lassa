...
const page = () => {
    ...
    return (
        <main className="pt-24 max-w-[1500px] mx-auto px-10">
            ...
            <div ref={formCardRef}
                ...
                className="contact-section max-w-[600px] m-auto mb-32 backdrop-blur-md bg-white rounded-xl shadow-md p-4 border">
                <form ref={formRef}
